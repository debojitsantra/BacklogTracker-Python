...
https://github.com/debojitsantra/BacklogTracker/releases/download/v1.1.3/BacklogTracker_Setup.exe

### Linux

https://github.com/debojitsantra/BacklogTracker/releases/download/v1.1.3/BacklogTracker_Linux.tar.gz

### macOS

https://github.com/debojitsantra/BacklogTracker/releases/download/v1.1.3/BacklogTracker_macOS.zip
